...
# =============================
# HMI로 WS 영상 + 상태 전송용 ZMQ
# =============================
ZMQ_WS_ADDR = "tcp://0.0.0.0:5579"   # 서버가 bind 하므로 0.0.0.0 추천
...
SEC = 'SYSTEM'
WORK_POS = "DS_POS"
IMG_POP = "Measuring DS-Wheel Status"
