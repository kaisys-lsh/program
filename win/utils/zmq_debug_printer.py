...
def print_zmq_debug(raw_text: str):
    ...
    # -----------------------------
        ...
        print("   - 앞바퀴 회전:", data.get("wheel_1st_rotation"),
              "/ 위치:", data.get("wheel_1st_position"))
        print("   - 뒷바퀴 회전:", data.get("wheel_2nd_rotation"),
    ...
    # -----------------------------
        ...
        print("   - 앞바퀴 회전:", wheel.get("wheel_1st_rotation"),
              "/ 위치:", wheel.get("wheel_1st_position"))
        print("   - 뒷바퀴 회전:", wheel.get("wheel_2nd_rotation"),
